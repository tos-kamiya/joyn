...
The order of lines in the output is "interleaved". That is, unlike the `catP command, lines in the file specified earlier in the command line may be output later.
